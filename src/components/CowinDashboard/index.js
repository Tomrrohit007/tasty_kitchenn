...
class CowinDashboard extends Component{
    ...
    state={ isLoading:true, last7DaysVaccination:[], vaccinationByAge:[], vaccinationByGender:[], apiStatus:apiStatusContant.intial}
    ...
    renderLoader=()=>{
        return <div className='loader-cont' data-testid="loader">
                    <Loader type="ThreeDots" color="#ffffff" height={80} width={80} />
                </div>
    }
    renderSuccess=()=>{
        const {vaccinationByAge, vaccinationByGender, last7DaysVaccination} = this.state
        return(
            <>
    ...
    renderFailure=()=>{
        return(
            <div className='failure-cont'>
                <img className='failure-img' src='https://assets.ccbp.in/frontend/react-js/api-failure-view.png' alt='failure view' />
    ...
    getData=async()=>{
        ...
        if(response.ok){
            this.setState({last7DaysVaccination, vaccinationByGender, vaccinationByAge, apiStatus:apiStatusContant.success, isLoading:false})
        }
        else{
    ...
    render(){
        ...
        return(<div className='main-cont'>
                <div className='context'>
                    ...
                    <img className='logo' src='https://assets.ccbp.in/frontend/react-js/cowin-logo.png' alt='website logo'/>
